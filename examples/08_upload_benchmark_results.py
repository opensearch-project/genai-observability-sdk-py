...
Usage:
    python examples/08_upload_benchmark_results.py
...
from opensearch_genai_observability_sdk_py import Benchmark, register
...
All results uploaded! Open agent-health UI to explore:
  - Benchmarks tab: see "custom-eval" and "ci-nightly" runs
